...
The majority of the plugin manager commands require to have direct access to the internet, if your organization is behind a firewall you can
set theses environments variables to configure Logstash to use your proxy.
